...
function preload() {
  ...
  pic = loadImage('Images/scream.PNG');
}
...
function clearParticle() {
  // Directly set the particle array to empty and clear all particles
  particles = [];
  personParticles = [];
}
...
/*
  ...
  // ���域�膊��合��篏�臀��隋��絎����筝㊦��罩ｇ｀篏�臀�
  boatY = max(boatY, 28/81 * img.height);  // 隋���剛��������筝��∫����
  if ((boatX * 40 / 81 + 30 / 81 * img.height) < boatY) {
    boatY = boatX * 40 / 81 + 30 / 81 * img.height;  // 篆����劫�����筝�������
  }
}
*/
